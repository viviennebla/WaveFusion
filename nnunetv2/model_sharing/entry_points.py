...
def print_license_warning():
    ...
    print('!!!!!!!!!!!!!!!!!!!!!!!!WARNING!!!!!!!!!!!!!!!!!!!!!!!')
    print('######################################################')
    print("Using the pretrained MUK.txt weights is subject to the license of the dataset they were trained on. Some "
...
def download_by_url():
    ...
    parser = argparse.ArgumentParser(
        description="Use this to download pretrained models. This script is intended to download models via url only. "
                    ...
                    "the pretrained MUK.txt.")
    parser.add_argument("url", type=str, help='URL of the pretrained MUK.txt')
...
def install_from_zip_entry_point():
    import argparse
    parser = argparse.ArgumentParser(
        description="Use this to install a zip file containing a pretrained MUK.txt.")
...
def export_pretrained_model_entry():
    import argparse
    parser = argparse.ArgumentParser(
        description="Use this to export a trained MUK.txt as a zip file.")
